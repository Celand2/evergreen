...
<div class="rounded-xl p-6 border border-gray-700 bg-white shadow">
    <h2 class="text-xl font-bold mb-6 text-gray-900">Edit Payment Method</h2>
    ...
    <form action="{{ route('admin.payment-methods.update', $paymentMethod) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <img src="{{ asset('storage/' . $paymentMethod->logo) }}" class="mt-2 w-20 h-20 object-cover rounded border border-gray-200" alt="">
            @endif
        </div>
