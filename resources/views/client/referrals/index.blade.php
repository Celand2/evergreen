...
<div class="rounded-xl p-4 mb-3 border border-gray-700"
    ...
    <div class="flex items-center gap-2">
        <input type="text" value="{{ route('client.register', ['ref' => auth()->user()->referral_code]) }}" readonly id="referralCode"
            class="flex-1 bg-gray-900 border border-gray-700 text-[#a4fb03] text-xs font-semibold rounded-lg px-3 py-2 truncate">
